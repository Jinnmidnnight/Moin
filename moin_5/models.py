...
class Open_5(models.Model):
    ...
    follower  = models.ManyToManyField(User, related_name='followers_5', blank=True, null=True)
...
class Write_5(models.Model):
    ...
    write_like = models.ManyToManyField(User, related_name='write_likes_5', blank=True)
