...
class Open_7(models.Model):
    ...
    follower  = models.ManyToManyField(User, related_name='followers_7', blank=True, null=True)
...
class Write_7(models.Model):
    ...
    write_like = models.ManyToManyField(User, related_name='write_likes_7', blank=True)
