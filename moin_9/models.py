...
class Open_9(models.Model):
    ...
    follower  = models.ManyToManyField(User, related_name='followers_9', blank=True, null=True)
...
class Write_9(models.Model):
    ...
    write_like = models.ManyToManyField(User, related_name='write_likes_9', blank=True)
