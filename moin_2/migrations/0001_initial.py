    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ManyToManyField(blank=True, null=True, related_name='followers_2', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='writes', to='moin_2.open_2')),
                ('write_like', models.ManyToManyField(blank=True, related_name='write_likes_2', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment_2',
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='moin_2.write_2')),
