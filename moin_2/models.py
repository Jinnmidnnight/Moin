...
class Open_2(models.Model):
    ...
    follower  = models.ManyToManyField(User, related_name='followers_2', blank=True, null=True)
...
class Write_2(models.Model):
    ...
    write_like = models.ManyToManyField(User, related_name='write_likes_2', blank=True)
