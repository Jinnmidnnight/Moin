...
class Open_8(models.Model):
    ...
    follower  = models.ManyToManyField(User, related_name='followers_8', blank=True, null=True)
...
class Write_8(models.Model):
    ...
    write_like = models.ManyToManyField(User, related_name='write_likes_8', blank=True)
