    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ManyToManyField(blank=True, null=True, related_name='followers_8', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='writes', to='moin_8.open_8')),
                ('write_like', models.ManyToManyField(blank=True, related_name='write_likes_8', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment_8',
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='moin_8.write_8')),
