...
class Open_4(models.Model):
    ...
    follower  = models.ManyToManyField(User, related_name='followers_4', blank=True, null=True)
...
class Write_4(models.Model):
    ...
    write_like = models.ManyToManyField(User, related_name='write_likes_4', blank=True)
