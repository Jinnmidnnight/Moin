...
class Open_6(models.Model):
    ...
    follower  = models.ManyToManyField(User, related_name='followers_6', blank=True, null=True)
...
class Write_6(models.Model):
    ...
    write_like = models.ManyToManyField(User, related_name='write_likes_6', blank=True)
