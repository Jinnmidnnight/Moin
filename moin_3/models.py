...
class Open_3(models.Model):
    ...
    follower  = models.ManyToManyField(User, related_name='followers_3', blank=True, null=True)
...
class Write_3(models.Model):
    ...
    write_like = models.ManyToManyField(User, related_name='write_likes_3', blank=True)
